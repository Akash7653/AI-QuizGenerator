...
async def get_recommendations(
    ...
    return await recommendation_service.get_user_recommendations(current_user.id, recommendation_type)
...
async def generate_recommendations(
    ...
    recommendation_service = RecommendationService()
    return await recommendation_service.generate_recommendations(current_user.id)
...
async def get_learning_path(
    ...
    recommendation_service = RecommendationService()
    return await recommendation_service.get_personalized_learning_path(current_user.id)
...
async def get_next_step(
    ...
    recommendation_service = RecommendationService()
    recommendations = await recommendation_service.get_user_recommendations(current_user.id)
...
async def complete_recommendation(
    ...
    recommendation = await recommendation_service.mark_recommendation_completed(
...
async def dismiss_recommendation(
    ...
    recommendation = await recommendation_service.dismiss_recommendation(
        recommendation_id, current_user.id
    )
...
async def update_recommendation_priority(
    ...
    recommendation = await recommendation_service.update_recommendation_priority(
...
async def get_revision_suggestions(
    ...
    recommendation_service = RecommendationService()
    return await recommendation_service.get_user_recommendations(current_user.id, "revision")

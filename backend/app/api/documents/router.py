...
async def upload_document(
    ...
    try:
        ...
        try:
            ...
            # Update document
            doc_repo.update_cleaned_text(document.id, cleaned_text, word_count)
            ...
            doc_repo.update_processing_error(document.id, str(e))
...
async def get_documents(
    ...
    documents = doc_repo.get_by_user_id(current_user.id, skip, limit)
    return documents
